...
class NavbarMurid extends StatefulWidget {
  const NavbarMurid({Key? key}) : super(key: key);

  @override
  State<NavbarMurid> createState() => _NavbarMuridState();
}

class _NavbarMuridState extends State<NavbarMurid> {
  int currentIndex = 0;
